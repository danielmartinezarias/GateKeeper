...
HD_PWD='C:/Users/danie/Documents/GitHub/GateKeeper/FPGA/GateKeeper/GateKeeper.runs/GateKeeper_BD_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log GateKeeper_BD_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GateKeeper_BD_axi_gpio_0_0.tcl
