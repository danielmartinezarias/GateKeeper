...
HD_PWD='C:/Users/danie/Documents/GitHub/GateKeeper/FPGA/GateKeeper/GateKeeper.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log GateKeeper_BD_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source GateKeeper_BD_wrapper.tcl -notrace
