...
ISEStep( "vivado",
         "-log GateKeeper_BD_control_parametros_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source GateKeeper_BD_control_parametros_0_1.tcl" );
