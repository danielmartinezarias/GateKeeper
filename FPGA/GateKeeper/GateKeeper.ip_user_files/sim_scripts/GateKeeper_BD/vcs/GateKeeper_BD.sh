...
design_libs=(xilinx_vip xpm xil_defaultlib axi_infrastructure_v1_1_0 axi_vip_v1_1_15 processing_system7_vip_v1_0_17 axi_lite_ipif_v3_0_4 lib_cdc_v1_0_2 interrupt_control_v3_1_5 axi_gpio_v2_0_31 proc_sys_reset_v5_0_14 generic_baseblocks_v2_1_1 fifo_generator_v13_2_9 axi_data_fifo_v2_1_28 axi_register_slice_v2_1_29 axi_protocol_converter_v2_1_29)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../BD/GateKeeper_BD/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_15 $vlogan_opts -sverilog +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../BD/GateKeeper_BD/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_17 $vlogan_opts -sverilog +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_1 $vlogan_opts +v2k +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../BD/GateKeeper_BD/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_9 $vlogan_opts +v2k +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_28 $vlogan_opts +v2k +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../BD/GateKeeper_BD/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_29 $vlogan_opts +v2k +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../BD/GateKeeper_BD/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_protocol_converter_v2_1_29 $vlogan_opts +v2k +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.GateKeeper_BD xil_defaultlib.glbl -o GateKeeper_BD_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./GateKeeper_BD_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key GateKeeper_BD_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc GateKeeper_BD_simv.daidir vcs_lib c.obj)
