...
#
# Script generated by Vivado on Thu Apr 03 16:25:53 +0200 2025
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : GateKeeper_BD.sh
...
#
# Usage        : GateKeeper_BD.sh
#                GateKeeper_BD.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                GateKeeper_BD.sh [-reset_run]
#                GateKeeper_BD.sh [-reset_log]
#                GateKeeper_BD.sh [-help]
#
...
#                script (type 'GateKeeper_BD.sh -help' for more information).
#
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./GateKeeper_BD.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../BD/GateKeeper_BD/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_15 $xmvlog_opts -sv +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../BD/GateKeeper_BD/ipshared/5753/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_17 $xmvlog_opts -sv +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_1 $xmvlog_opts +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../BD/GateKeeper_BD/ipshared/10ab/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_9 $xmvlog_opts +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_28 $xmvlog_opts +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../BD/GateKeeper_BD/ipshared/279e/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_29 $xmvlog_opts +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
  "../../../../BD/GateKeeper_BD/ipshared/ff9f/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_29 $xmvlog_opts +incdir+"../../../../BD/GateKeeper_BD/ipshared/c2c6" +incdir+"../../../../BD/GateKeeper_BD/ipshared/ec67/hdl" +incdir+"../../../../BD/GateKeeper_BD/ipshared/6b2b/hdl" +incdir+"C:/Xilinx/Vivado/2023.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.GateKeeper_BD xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.GateKeeper_BD -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log GateKeeper_BD_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./GateKeeper_BD.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: GateKeeper_BD.sh [-help]\n\
Usage: GateKeeper_BD.sh [-step]\n\
Usage: GateKeeper_BD.sh [-lib_map_path]\n\
Usage: GateKeeper_BD.sh [-reset_run]\n\
Usage: GateKeeper_BD.sh [-reset_log]\n\
Usage: GateKeeper_BD.sh [-keep_index]\n\
Usage: GateKeeper_BD.sh [-noclean_files]\n\n\
