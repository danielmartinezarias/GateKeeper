...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, readyRx, bufferRx, SW, LED, window, 
  pulseShaper_width, enableGateKeeper)
/* synthesis syn_black_box black_box_pad_pin="readyRx,bufferRx[7:0],SW[7:0],LED[7:0],window[15:0],pulseShaper_width[7:0],enableGateKeeper" */
